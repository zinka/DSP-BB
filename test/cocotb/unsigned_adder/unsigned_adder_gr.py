...
class unsigned_adder_gr(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Unsigned Adder Gr")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'data_sum.bin', False)
...
def main(top_block_cls=unsigned_adder_gr, options=None):
    tb = top_block_cls()
